...
const Cards = ({ subscriptionPlan }: PageProps) => {
    ...
    return (
            ...
            className={`flex flex-col mt-20 gap-6 items-center justify-center min-h-[100vh]  ${
                filteredTarotCards && filteredTarotCards.length > 0
                    ? filteredTarotCards[0].suit === "pentacles"
                        ...
                        ? "bg-gradient-to-t from-green-100/10 via-yellow-700/40 to-green-100/10"
                        : filteredTarotCards[0].suit === "cups"
                        ? "bg-gradient-to-t from-sky-100/10 via-slate-600/40 to-sky-100/10"
        ...
        >
            ...
            {isSelected && (
                <div className="bg-gradient-to-t from-orange-100/10 via-orange-500/40 to-orange-100/20 mt-24 px-8">
