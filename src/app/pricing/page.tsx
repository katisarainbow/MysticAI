...
const Page = async () => {
    ...
    const pricingItems = [
        ...
        {
            plan: "Pro",
            tagline: "For larger answers and more questions.",
            ...
            features: [
                ...
                {
                    text: "Unlimited spread types",
                    footnote: "Supports to one-card to six-card spreads.",
                    negative: true,
                },
            ],
        },
    ...
    return (
        <div>
            <MaxWidthWrapper className="mb-8 mt-24 text-center">
                ...
                <div className="pt-12 grid grid-cols-1 gap-5 lg:grid-cols-3 bg-gradient-to-t from-orange-100/20 via-orange-300 to-orange-100/20 rounded-lg">
                    <TooltipProvider>
                        {pricingItems.map(
